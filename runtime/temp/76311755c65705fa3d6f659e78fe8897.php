<?php /*a:1:{s:66:"D:\phpstudy_pro\WWW\jijin\application\index\view\jijin\sellok.html";i:1614595597;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label for="phone" class="layui-form-label">
                            <span class="x-red">*</span>确认卖出份额</label>
                        <div class="layui-input-inline">
                            <input type="text" id="sell_share" name="sell_share" required="" lay-verify="number" autocomplete="off" class="layui-input" ></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="phone" class="layui-form-label">
                            <span class="x-red">*</span>确认卖出净值</label>
                        <div class="layui-input-inline">
                            <input type="text" id="sell_worth" name="sell_worth" required="" lay-verify="number" autocomplete="off" class="layui-input" ></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="phone" class="layui-form-label">
                            <span class="x-red">*</span>确认卖出时间</label>
                        <div class="layui-input-inline">
                            <input type="text" id="sell_final_time" name="sell_final_time" required="" lay-verify="required" autocomplete="off" class="layui-input" value="<?php echo htmlentities($timeNow); ?>"></div>
                    </div>
                ...
                function(data) {
                    ...
                    $.ajax({
                        ...
                        data:{
                            ...
                            sell_share:data.field.sell_share,
                            sell_worth:data.field.sell_worth,
                            sell_final_time:data.field.sell_final_time,
                        },
                        // beforeSend:function () {

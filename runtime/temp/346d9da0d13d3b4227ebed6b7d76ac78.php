<?php /*a:1:{s:64:"D:\phpstudy_pro\WWW\jijin\application\index\view\jijin\sell.html";i:1614595593;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label for="phone" class="layui-form-label">
                            <span class="x-red">*</span>卖出价格</label>
                        <div class="layui-input-inline">
                            <input type="text" id="sell_price" name="sell_price" required="" lay-verify="number" autocomplete="off" class="layui-input" ></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="phone" class="layui-form-label">
                            <span class="x-red">*</span>卖出时间</label>
                        <div class="layui-input-inline">
                            <input type="text" id="sell_time" name="sell_time" required="" lay-verify="required" autocomplete="off" class="layui-input" value="<?php echo htmlentities($timeNow); ?>"></div>
                    </div>
<!--                    <div class="layui-form-item">-->
<!--                        <label for="phone" class="layui-form-label">-->
<!--                            <span class="x-red">*</span>确认买入时间</label>-->
<!--                        <div class="layui-input-inline">-->
<!--                            <input type="text" id="buy_final_time" name="buy_final_time" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>-->
<!--                    </div>-->
                ...
                function(data) {
                    ...
                    $.ajax({
                        ...
                        data:{
                            ...
                            sell_price:data.field.sell_price,
                            sell_time:data.field.sell_time,
                        },
                        // beforeSend:function () {
